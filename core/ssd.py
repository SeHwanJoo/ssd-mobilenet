...
from core.models.mobilenet_v3_small import MobileNetV3Small
from core.models.mobilenet_v2 import mobilenet_v2
from core.models.resnet import ResNet50
from core.models.vgg16 import VGG16
from configuration import NUM_CLASSES, ASPECT_RATIOS, IMAGE_HEIGHT, IMAGE_WIDTH, CHANNELS
...
class SSD(tf.keras.Model):
    def __init__(self):
        ...
        self.learnable_factor = self.add_weight(shape=(1, 1, 1, 51K2), dtype=tf.float32, initializer=tf.keras.initializers.Ones(), trainable=True)
        # self.conv1_1 = tf.keras.layers.Conv2D(filters=576, kernel_size=(1, 1), strides=1, padding="same")
        # self.conv1_2 = tf.keras.layers.Conv2D(filters=1152, kernel_size=(3, 3), strides=2, padding="same")
