...
class ReadDataset(object):
    ...
    def __get_image_information(single_line):
        ...
        name = line_list[0].split('/')[-1][:-4]
        return image_file, boxes_array, name
    ...
    def read(self, batch_data):
        ...
        for item in range(batch_data.shape[0]):
            image_file, boxes, name = self.__get_image_information(single_line=batch_data[item])
