...
class InferenceProcedure(object):
    ...
    def __offsets_to_true_coordinates(self, pred_boxes, ssd_output):
        ...
        d_cx, d_cy, d_w, d_h = default_boxes[:, 0:1], default_boxes[:, 1:2], default_boxes[:, 2:3], default_boxes[:,
                                                                                                    3:4]
        offset_cx, offset_cy, offset_w, offset_h = pred_coords[:, 0:1], pred_coords[:, 1:2], pred_coords[:,
                                                                                             2:3], pred_coords[:, 3:4]
